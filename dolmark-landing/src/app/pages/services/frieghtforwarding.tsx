...
},
{
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section id="frieghtforwarding" className="bg-gradient-to-br from-[#0F2C59] to-[#061526] py-20 px-6 md:px-12 lg:px-20 relative overflow-hidden flex flex-col justify-start">
